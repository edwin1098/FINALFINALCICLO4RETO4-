...
public class OrderService {
    ...
    // Servicio para traer ordenes por id de vendedor Reto4 FG
    public List<Order> getSalesManId (Integer id){
        return orderRepository.getSaleManId(id);
    }
    
    // Servicio para traer ordenes por status y id de vendedor Reto4 FG
    public List<Order> getSalesManIdAndStatus (Integer id, String status){
        return orderRepository.getSaleManIdAndStatus(id, status);
    }
    
    // Servicio para traer ordenes por fecha de Registro y Id del vendedor Reto4 FG
